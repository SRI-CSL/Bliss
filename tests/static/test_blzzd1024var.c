...
int test_mul_from_KAT_values() {
  ...
  if (ua  != NULL  && ub != NULL &&  uc != NULL) {
    ...
    for (int i = 0; i < REPETITIONS; i++) {
      ...
      ntt32_fft1024_var4(ua, 12289, w12289n1024);

      ntt32_xmu(ub, 1024, 12289, b[i], w12289n1024);
      ntt32_fft1024_var4(ub, 12289, w12289n1024);

      ntt32_xmu(uc, 1024, 12289, ua, ub);
      ntt32_fft1024_var4(uc, 12289, w12289n1024);
...
int main(void){
  printf("\nTesting ntt from blzzd1024_var4 (KAT values)\n");
