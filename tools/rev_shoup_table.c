 ...
 */
static void build_rev_shoup_table(uint32_t *a, uint32_t n, uint32_t q, uint32_t phi) {
  uint32_t t, j, i, k;
  uint32_t x, y;
...
int main(int argc, char *argv[]) {
  ...
  build_rev_shoup_table(table, n, q, phi);
  print_table(stdout, "rev_shoup_ntt", table, n, q);
